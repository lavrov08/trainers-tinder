...
async def cmd_start(message: Message, db: Database, state: FSMContext):
    ...
    # Базовое приветствие
    welcome_text = (
        "👋 Добро пожаловать в <b>Tinder для тренеров!</b> by @cultphysique\n\n"
        "Спасибо, что подписались на нас. Добро пожаловать в наше спортивное сообщество.\n\n"
        "Всем новым подписчикам подарок 🎁\n\n"
